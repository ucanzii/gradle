...
public interface CollectionPropertyConfigurer<T> extends ConfigurableValue.Configurer {
     ...
     *
     * <p>
     * Contrary to {@link #add(Object)}, this method operates on the
     ...
     *
     * <p>
     * Contrary to {@link #add(Provider)}, this method operates on the
     * actual value of the property, be it defined via a convention or explicit value.
     * </p>
     *
     * @param provider The provider of an element
     ...
     *
     * <p>
     * Contrary to {@link #addAll(Object[])}, this method operates on the
     * actual value of the property, be it defined via a convention or explicit value.
     * </p>
     *
     * @param elements The elements to add
     ...
     *
     * <p>
     * Contrary to {@link #addAll(Iterable)}, this method operates on the
     * actual value of the property, be it defined via a convention or explicit value.
     * </p>
     *
     * @param elements The elements to add.
     ...
     *
     * <p>
     * Contrary to {@link #addAll(Provider)}, this method operates on the
     * actual value of the property, be it defined via a convention or explicit value.
     * </p>
     *
     * @param provider Provider of elements
