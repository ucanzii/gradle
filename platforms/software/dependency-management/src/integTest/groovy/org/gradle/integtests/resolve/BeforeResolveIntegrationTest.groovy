...
"""
        ...
        when:
        executer.expectDocumentedDeprecationWarning("Mutating the dependency attributes of configuration ':conf' after it has been locked for mutation has been deprecated. This will fail with an error in Gradle 9.0. After a Configuration has been resolved, observed via dependency-management, or published, it should not be modified further. Consult the upgrading guide for further information: https://docs.gradle.org/current/userguide/upgrading_version_8.html#mutate_configuration_after_locking")
        succeeds 'printFilesWithConfigurationInput'
...
"""
        ...
        expect:
        executer.expectDocumentedDeprecationWarning("Mutating the dependency attributes of parent of configuration ':testCompileClasspath' after it has been locked for mutation has been deprecated. This will fail with an error in Gradle 9.0. After a Configuration has been resolved, observed via dependency-management, or published, it should not be modified further. Consult the upgrading guide for further information: https://docs.gradle.org/current/userguide/upgrading_version_8.html#mutate_configuration_after_locking")
        executer.expectDocumentedDeprecationWarning("Mutating the dependency attributes of parent of configuration ':testImplementation' after it has been locked for mutation has been deprecated. This will fail with an error in Gradle 9.0. After a Configuration has been resolved, observed via dependency-management, or published, it should not be modified further. Consult the upgrading guide for further information: https://docs.gradle.org/current/userguide/upgrading_version_8.html#mutate_configuration_after_locking")
        executer.expectDocumentedDeprecationWarning("Mutating the dependency attributes of parent of configuration ':mainSourceElements' after it has been locked for mutation has been deprecated. This will fail with an error in Gradle 9.0. After a Configuration has been resolved, observed via dependency-management, or published, it should not be modified further. Consult the upgrading guide for further information: https://docs.gradle.org/current/userguide/upgrading_version_8.html#mutate_configuration_after_locking")
        executer.expectDocumentedDeprecationWarning("Mutating the dependency attributes of parent of configuration ':runtimeElements' after it has been locked for mutation has been deprecated. This will fail with an error in Gradle 9.0. After a Configuration has been resolved, observed via dependency-management, or published, it should not be modified further. Consult the upgrading guide for further information: https://docs.gradle.org/current/userguide/upgrading_version_8.html#mutate_configuration_after_locking")
        executer.expectDocumentedDeprecationWarning("Mutating the dependency attributes of parent of configuration ':compileClasspath' after it has been locked for mutation has been deprecated. This will fail with an error in Gradle 9.0. After a Configuration has been resolved, observed via dependency-management, or published, it should not be modified further. Consult the upgrading guide for further information: https://docs.gradle.org/current/userguide/upgrading_version_8.html#mutate_configuration_after_locking")
