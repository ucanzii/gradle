...
class ReadelfBinaryInfoTest extends Specification {
    def "reads symbols from readelf"() {
        when:
        def input = """
Contents of the .debug_line section:

/opt/gradle_gradle/platforms/native/platform-native/build/tmp/teŝt files/ExtractSymb.Test/thn3z/src/main/cpp/sum.cpp:
File name                            Line number    Starting address    View    Stmt
src/main/cpp/sum.cpp                           4              0x1200               x
src/main/cpp/sum.cpp                           5              0x120e               x
src/main/cpp/sum.cpp                           5              0x1211
src/main/cpp/sum.cpp                           5              0x1214
src/main/cpp/sum.cpp                           -              0x1216


/opt/gradle_gradle/platforms/native/platform-native/build/tmp/teŝt files/ExtractSymb.Test/thn3z/src/main/cpp/greeter.cpp:
File name                            Line number    Starting address    View    Stmt

/usr/include/x86_64-linux-gnu/bits/src/main/cpp/greeter.cpp:
src/main/cpp/greeter.cpp                       0              0x1090               x

/opt/gradle_gradle/platforms/native/platform-native/build/tmp/teŝt files/ExtractSymb.Test/thn3z/build/obj/main/debug/iostream:
iostream                                      74              0x1094               x

/usr/include/x86_64-linux-gnu/bits/src/main/cpp/greeter.cpp:
src/main/cpp/greeter.cpp                       0              0x10a0
...
/usr/include/x86_64-linux-gnu/bits/src/main/cpp/greeter.cpp:
src/main/cpp/greeter.cpp                       0              0x10c0               x
src/main/cpp/greeter.cpp                       -              0x10cb


/usr/include/x86_64-linux-gnu/bits/src/main/cpp/greeter.cpp:
src/main/cpp/greeter.cpp                       6              0x1220               x
src/main/cpp/greeter.cpp                       7              0x122c               x
src/main/cpp/greeter.cpp                       7              0x1242
src/main/cpp/greeter.cpp                       8              0x124e               x
src/main/cpp/greeter.cpp                       -              0x1254


/opt/gradle_gradle/platforms/native/platform-native/build/tmp/teŝt files/ExtractSymb.Test/thn3z/src/main/cpp/main.cpp:
File name                            Line number    Starting address    View    Stmt
"""
        def inputLines = input.readLines()

        then:
        ReadelfBinaryInfo.readSymbols(inputLines)*.name == ['sum.cpp', 'greeter.cpp', 'main.cpp']
    }
